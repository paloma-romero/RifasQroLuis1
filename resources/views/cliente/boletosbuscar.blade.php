...
@section('content')
            ...
            <div class="fondo-con-imagen ">
                <div class="container mt-10 col-md-10 texto-opaco text-center">
                    <div class="row">
                        ...
                        <div class="col-md-8 mx-auto ">
                            ...
                            <h4 class="text-center" style="color: #6b0000; font-family: 'Arial Black'; font-size: 20px; text-align: left;">
                                XTRAIL 2016 - 
                                <span style="color: #000000; font-family: 'Arial Black'; font-size: 20px;">5 DE ABRIL</span>
                            </h4>
                            <h4 class="text-center" style="color: #6b0000; font-family: 'Arial Black'; font-size: 20px; text-align: left;">
                    ...
                    <div class="col-md-auto mx-auto">
                        <div class="custom-textarea" contenteditable="true">
                            @foreach ($consultaB as $bol) 
                                @if ($bol->fechaApartado == null)
                                    <button onclick="agregarElemento('{{ $bol->boleto }}', this)" class="boletos-content d-inline-block mr-2 mb-2">
                                        {{ $bol->boleto }}
                                    </button>
                                @else
                                <span style="color: #000000; font-family: 'Arial Black'; font-size: 15px;">
                    ...
                    <div class="col-md-8 mx-auto">
                        <h3 class="text-center" style="color: #8b0000; font-family: 'Arial Black';">BOLETOS DISPONIBLES</h3>
                    </div>
  ...
  <style>
    .custom-textarea {
    width: 100%;
    height: 250px; /* Altura ajustable según tus necesidades */
    padding: 10px;
    border: 1px solid #ccc;
    border-radius: 10px;
    overflow-y: auto; /* Añadir barras de desplazamiento vertical si el contenido es demasiado largo */
    font-family: Arial, sans-serif; /* Establecer una fuente adecuada */
    font-size: 15px; /* Tamaño de fuente ajustable según tus necesidades */
}
    .fondo-con-imagen {
